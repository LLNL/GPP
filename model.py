...
def generator_sn(z,train_mode,reuse=None):
    print('Generator')
    with tf.variable_scope('Generator',reuse=reuse):
           # reshape from inputs
           w_fc1 = weight_variable([100,512*4*4],stddev=0.02, name="w_fc1")
           b_fc1 = bias_variable([512*4*4], name="b_fc1")
           h_fc1 = bn(tf.nn.relu(tf.matmul(z, SN(w_fc1,"sn1")) + b_fc1), train_mode,"bn1")
           ...
           h_conv_t1 = conv2d_transpose_strided(h_reshaped, SN(W_conv_t1,"sn2"), b_conv_t1,output_shape=deconv_shape)
           ...
           h_conv_t2 = conv2d_transpose_strided(h_relu_t1, SN(W_conv_t2,"sn3"), b_conv_t2,output_shape=deconv_shape)
           ...
           h_conv_t3 = conv2d_transpose_strided(h_relu_t2, SN(W_conv_t3,"sn4"), b_conv_t3,output_shape=deconv_shape)
...
def encoder(data,dim_z,train_mode,reuse=None):
    ...
    with tf.variable_scope('Encoder', reuse=reuse):
        ...
        w_fc1 = weight_variable([2*2*512, dim_z], name="d_w_fc1")
        b_fc1 = bias_variable([dim_z], name="d_b_fc1")
